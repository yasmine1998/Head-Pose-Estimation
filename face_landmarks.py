...
def get_dlib_landmark_model():
    return dlib.shape_predictor("utils/models/shape_predictor_5_face_landmarks.dat")
...
def detect_marks_dlib(img, model, rect):
    box = get_square_box(rect)
    (bX1, bY1, bX2, bY2) = box
    shape = model(img,  dlib.rectangle(bX1, bY1, bX2, bY2) )
